...
public class H2Config {
	...
	public static Customer getCustomer(Connection conn, String customerId) throws Exception {
	...
	public static Vehicle getVehicle(Connection conn, String vin) throws Exception {
